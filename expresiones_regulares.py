...
def run():
    ...
    print("Los objetos coincidentes siempre tienen un valor booleano: True.\n"
          "Como match () y search () devuelven None cuando no coinciden, se\n"
          "puede probar si hubo una coincidencia con una "
          "instrucción if simple:")

    regxmail = r"[\w\._]{5,30}\+?[\w]{0,10}@[\w\.\-]{3,}\.\w{2,5}"
    if(re.search(regxmail, "super.email@valido.net")):
